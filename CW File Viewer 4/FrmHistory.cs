...
{
    public partial class FrmHistory : DevComponents.DotNetBar.Metro.MetroAppForm
    {
        int i;
        public FrmHistory()
        {
        ...
        private void FrmHistory_Load(object sender, EventArgs e)
        {
            ...
            {
                BaseClass.SHFILEINFO shfi = new BaseClass.SHFILEINFO();
                BaseClass.SHGetFileInfo(Gib.hispath[i], (uint)0x80, ref shfi, (uint)System.Runtime.InteropServices.Marshal.SizeOf(shfi), (uint)(0x100 | 0x400));
                try
                {
        ...
        private void hisv_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(Gib.fpos[Gib.nowtab, Gib.nowp[Gib.nowtab] + 1]))
            {
                ...
                frmm.reffile(Gib.fpos[Gib.nowtab, Gib.nowp[Gib.nowtab]], Gib.smode);
